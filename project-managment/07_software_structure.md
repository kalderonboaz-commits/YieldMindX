...
Status: reusable scaffold guidance, added 2026-09-10. This layout supports a frontend, backend and databases; it does not change Snake3d requirements or select a backend language, database engine or cloud. Record actual choices in 02_spec.md before implementation. There is no single universal "SOTA" folder tree.
